            ...
            <table class="table">
                ...
                <tbody>
                    @forelse($pelanggan as $p)
                       @php
                    $produkList = \App\Models\Produk::where('stok', '>', 0)->pluck('nama_produk');

                    if ($produkList->isNotEmpty()) {
                        $barang = $produkList->random();
                        $garansi = rand(6, 18) . ' bulan';
                        $tooltip = "Barang dibeli: {$barang}\nGaransi: {$garansi}";
                    } else {
                        $tooltip = 'Belum ada produk di stok.';
                    }
                @endphp
                        <tr>
                            <td class="text-center">
                                ...
                                <td class="tooltip-custom" data-tooltip="{{ e($tooltip) }}">
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <a 
                                        href="{{ route('pelanggan.edit', $p->id_pelanggan) }}" 
